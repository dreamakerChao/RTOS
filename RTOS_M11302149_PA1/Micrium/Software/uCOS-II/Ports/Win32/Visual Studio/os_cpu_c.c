...
void  OSIntCtxSw (void)
{
    ...
    //printf("%d\ttask(%d)(%d)\ttask(%d)(%d)\t%d\n", OSTimeGet(), OSTCBCur->OSTCBId, OSTCBCur->OSTCBPrio, OSTCBHighRdy->OSTCBId, OSTCBHighRdy->OSTCBPrio,);
}
